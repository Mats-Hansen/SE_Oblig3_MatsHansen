...
public class Main {
    ...
    // Dette er kommenter ut pga funksjonen ble laget før testene og oppgaven var å lage funksjon med TDD
    /*
    // This method checks if the year is a leap year
    public static boolean isLeapYear(int year) {
        // Checks if number is divisible by 4 but not 100 or if it's divisible by 400
